    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>
            <code>../../../../routes/dashboard.jsx</code>{" "}
            <i>
              (these are the routes for all of the Dashboard views -{" "}
              <code>../../../../views</code> - these are set to be rendered on the{" "}
              <code>{`/*`}</code> route)
            </i>
          </li>
          <li>
            <code>../../../../routes/pages.jsx</code>{" "}
            <i>
              (these are the routes for the Pages views -{" "}
              <code>../../../../views/pages</code> these are set to be rendered on the{" "}
              <code>{`/pages/*`}</code> route)
            </i>
          </li>
          <li>
            <code>../../../../routes/rtl.jsx</code>{" "}
            <i>
              (this is the route for RTLSupport view -{" "}
              <code>../../../../views/pages/RTLSupport.jsx</code> these are set to be
              rendered on the <code>{`/rtl/*`}</code> route)
            </i>
          </li>
        </ul>
        <h2>
        ...
        <p>
          If you want to change our routing system, for example you want the{" "}
          <code>Pages</code> layout to be rendered on the <code>{`/*`}</code>{" "}
          route, then you need to delete the <code>/pages</code> from all the
          pages routes (see above) and also need to change the routes from{" "}
          <code>Dashboard</code> layout to something else, for example{" "}
          <code>{`/admin/*`}</code>, so before any route inside the dashboard
          routes (see above) you need to add <code>/admin</code>.
        </p>
        <h1>Legend</h1>
        ...
        <p>
          This routes are beeing rendered in <code>../../../../index.js</code>.
        </p>
        <p>
        ...
        <p>
          ...
          <code>../../../../routes/index.jsx</code> to create as many layouts as you
        ...
        <p>
          You will find all our demo layouts in <code>../../../../layouts</code> (<code>
            Dashboard
        ...
        <h2>
          <code>../../../../routes/dashboard.jsx</code> and{" "}
          <code>../../../../routes/rtl.jsx</code>
        </h2>
        <p>
          These are the routes for the all pages/views that appear in the
          Dashboard layout (these pages can be found in <code>../../../../views/*</code>).
        </p>
        <p>
          You will see these routes beeing used/rendered in{" "}
          <code>../../../../layouts/Dashboard.jsx</code> (see lines 24-38 in this
          component).
        </p>
        <p>
          You will see that we've used <code>react-router-dom</code>'s
        ...
        <p>
          ...
          the <code>../../../../components/Sidebar/Sidebar.jsx</code> (see lines
          222-368) and the navbar brand in{" "}
          <code>../../../../components/Header/Header.jsx</code> (see lines 25-42).
        </p>
        <p>
          The difference between <code>../../../../routes/dashboard.jsx</code> and{" "}
          <code>../../../../routes/rtl.jsx</code> is that one has english names, and one
          has arabic names.
        </p>
        <h3>Legend</h3>
        <ul>
          ...
          <ul>
            <li>
              ...
              <code>../../../../components/Sidebar/Sidebar.jsx</code>, see line 225. In
              the <code>../../../../layouts/Dashboard.jsx</code> it will be rendered as
            ...
            <li>
              ...
              a <b>navbar brand</b> in{" "}
              <code>../../../../components/Header/Header.jsx</code>, if not set, than{" "}
              <b>Default Navbar</b> will be rendered as the navbar brand)
            </li>
          </ul>
          <li />
          <SyntaxHighlighter language="jsx" style={prism}>
          ...
          <ul>
            ...
            <li>
              ...
              <code>../../../../components/Sidebar/Sidebar.jsx</code> component as a
            ...
            <li>
              ...
              <code>../../../../components/Sidebar/Sidebar.jsx</code> component)
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              <code>../../../../components/Sidebar/Sidebar.jsx</code> component used to
              know if the collapse is open or not)
            </li>
            <li>
              <code>icon</code> (icon to be displayed alongside with collapse
              links in <code>../../../../components/Sidebar/Sidebar.jsx</code>{" "}
              component)
            </li>
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  the <code>../../../../components/Sidebar/Sidebar.jsx</code> component
                  as a link and as a navbar brand in{" "}
                  <code>../../../../components/Header/Header.jsx</code>, if not set,
                  than <b>Default Navbar</b> will be rendered as the navbar
                  brand)
                </li>
                <li>
        ...
        <p>
          ...
          <code>../../../../views/pages/*</code>).
        </p>
        <p>
          You will see these routes beeing used/rendered in{" "}
          <code>../../../../layouts/Pages.jsx</code> (see lines 44-62 in this
          component).
        </p>
        <p>
          You will see that we've used <code>react-router-dom</code>'s
        ...
        <p>
          These routes have also been used to create the links that appear in
          the <code>../../../../components/Sidebar/Sidebar.jsx</code> (<code>
            Pages collapse
          </code>, see lines 39-58 and line 73 inside{" "}
          <code>../../../../routes/dashboard.jsx</code>) and to create the links that
          appear in <code>../../../../components/Header/PagesHeader.jsx</code> (see
          lines 60-83).
        </p>
        <h3>Legend</h3>
        <ul>
          ...
          <ul>
            <li>
              <code>redirect</code> (Used to tell our demo app components this
              is a redirect. It will be ignored in the{" "}
              <code>../../../../components/Sidebar/Sidebar.jsx</code>, see line 295. In
              the <code>../../../../layouts/Pages.jsx</code> it will be rendered as a{" "}
            ...
            <li>
              <code>name</code> (name of the route - used to display the name as
              a navbar brand in <code>../../../../components/Header/Header.jsx</code>,
              if not set, than <b>Default Navbar</b> will be rendered as the
              navbar brand)
            </li>
          </ul>
          <li />
          ...
          <ul>
            ...
            <li>
              ...
              <code>../../../../components/Header/PagesHeader.jsx</code> component)
            </li>
            <li>
              <code>mini</code> (mini name to be displayed alongside with links
              in <code>../../../../components/Sidebar/Sidebar.jsx</code> component)
            </li>
            <li>
              <code>icon</code> (icon to be displayed alongside with collapse
              links in <code>../../../../components/Header/PagesHeader.jsx</code>{" "}
              component)
            </li>
            <li>
              <code>component</code> (this is the page to be rendered at the
