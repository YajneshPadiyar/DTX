  ...
  return (
    <div>
      ...
      <p>
        ...
        wrapper div inside <code>../../../../layouts/Dashboard.jsx</code>,{" "}
        <code>SidebarWrapper</code> component inside{" "}
        <code>../../../../components/Sidebar/Sidebar.jsx</code> and <code>wrapper</code>{" "}
        div inside <code>../../../../layouts/Pages.jsx</code> so we will have a nice
      ...
      <p>
        ...
        <code>
          ../../../../assets/scss/material-dashboard-pro-react/plugins/_plugin-perfect-scrollbar.scss
        </code>.
      </p>
    </div>
  );
